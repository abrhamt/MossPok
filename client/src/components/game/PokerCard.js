...
// ⚡ Bolt: Prevent unnecessary re-renders when card object reference changes
// but the semantic value (suit, rank) and other props remain the same.
...
export default React.memo(PokerCard, propsAreEqual);
