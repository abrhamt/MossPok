...
// ⚡ Bolt: Memoize PokerCard with custom comparison to avoid re-renders when the game state updates frequently (since cards in the board or hand remain identical for a while).
