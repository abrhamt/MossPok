...
// Prevents re-renders of the PokerCard by deep comparing the nested 'card' object (suit, rank)
// and dynamically shallow comparing other props to ensure resilience to future prop additions.
